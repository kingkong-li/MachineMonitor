...
public class SensorListModel implements SensorListContract.ISensorListModel {
    private static final String TAG =SensorListModel.class.getSimpleName() ;


    @Override
    public void getSensorList(int machineId, int machineType, final OnHttpCallBack<List<SensorInfo>> callBack) {
